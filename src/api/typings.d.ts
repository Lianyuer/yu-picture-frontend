declare namespace API {
  ...
  type getSpaceCategoryAnalyzeUsingGETParams = {
    queryAll?: boolean
    queryPublic?: boolean
    spaceId?: number
  }

  type getSpaceRankAnalyzeUsingGETParams = {
    topN?: number
  }

  type getSpaceSizeAnalyzeUsingGETParams = {
    queryAll?: boolean
    queryPublic?: boolean
    spaceId?: number
  }

  type getSpaceTagAnalyzeUsingGETParams = {
    queryAll?: boolean
    queryPublic?: boolean
    spaceId?: number
  }

  type getSpaceUsageAnalyzeUsingGETParams = {
    queryAll?: boolean
    queryPublic?: boolean
    spaceId?: number
  }

  type getSpaceUserAnalyzeUsingGETParams = {
    queryAll?: boolean
    queryPublic?: boolean
    spaceId?: number
  ...
  type pictureReviewUsingPOSTParams = {
    id?: number
    reviewMessage?: string
    reviewStatus?: number
  }
