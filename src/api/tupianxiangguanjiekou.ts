...
/** 删除图片接口 POST /api/picture/delete */
...
/** 用户编辑图片接口 POST /api/picture/edit */
...
/** 批量编辑图片接口 POST /api/picture/edit/batch */
...
/** 管理员根据 id 获取图片接口 GET /api/picture/get */
...
/** 根据 id 获取图片封装信息接口 GET /api/picture/get/vo */
...
/** 管理员分页查询图片列表接口 POST /api/picture/list/page */
...
/** 分页查询图片列表封装类 POST /api/picture/list/page/vo */
...
/** 使用缓存分页查询图片列表封装类 POST /api/picture/list/page/vo/cache */
...
export async function pictureReviewUsingPost(
  // 叠加生成的Param类型 (非body参数swagger默认没有生成对象)
  params: API.pictureReviewUsingPOSTParams,
  options?: { [key: string]: any }
) {
...
/** 获取图片标签分类列表接口 GET /api/picture/tag_category */
...
/** 管理员更新图片接口 POST /api/picture/update */
